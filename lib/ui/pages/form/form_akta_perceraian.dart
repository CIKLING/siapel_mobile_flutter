...
class FormAktaPerceraian extends StatefulWidget {
  const FormAktaPerceraian({Key? key}) : super(key: key);

  @override
  State<FormAktaPerceraian> createState() => _FormAktaPerceraianState();
}

class _FormAktaPerceraianState extends State<FormAktaPerceraian> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              uploadButton(
                  'Putusan Penetapan Pengadilan (Mempunyai Kekuatan Hukum Tetap)'),
              uploadButton('Kartu Keluarga'),
              uploadButton('KTP'),
