...
class KategoriSuratPindah extends StatefulWidget {
  const KategoriSuratPindah({Key? key}) : super(key: key);

  @override
  State<KategoriSuratPindah> createState() => _FormLayananDisabilitasAnak();
}

class _FormLayananDisabilitasAnak extends State<KategoriSuratPindah> {
  ...
  Future<void> _kategoripindah() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        FormData formData = FormData.fromMap({
          ...
          'img2': await validateAndPrepareFile(
              selectedFiles['Formulir f1-01 (Perubahan Elemen KK / Pisah KK)']),
          'img3': await validateAndPrepareFile(
              selectedFiles['Formulir f1-06 (Perubahan Elemen KK Barcode)']),
          'img4': await validateAndPrepareFile(selectedFiles[
              'F1-03 (Perubahan Alamat / Pindah Dalam Kota / Pisah KK)']),
          'img5': await validateAndPrepareFile(
              selectedFiles['SPTJM Pendaftaran Penduduk']),
          'img6': await validateAndPrepareFile(
              selectedFiles['Surat Pernyataan Tempat Tinggal (Untuk Pindah)']),
          'img7': await validateAndPrepareFile(
              selectedFiles['Surat Keterangan Hilang/KK Rusak']),
          'img8':
              await validateAndPrepareFile(selectedFiles['KTP (Hilang/Rusak)']),
          'img9': await validateAndPrepareFile(
              selectedFiles['Dokumen Pendukung Lain']),
          'selfie':
        ...
        final response = await dio.post(
          'http://10.101.1.154:8000/pindahmasuk_keluar/create',
          data: formData,
          options: Options(
  ...
  Widget inputSection() {
    ...
    Widget uploadformulirF101(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadformulirf106(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadperubahanalamat(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadSPTJMdafduk(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadsuratpernyataantempattinggal(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadketeranganhilangkk(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadktphilang(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploaddokumenpendukung(String Judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
      ...
      Form(
        ...
        child: Column(
          ...
          children: [
            ...
            uploadformulirF101(
                'Formulir f1-01 (Perubahan Elemen KK / Pisah KK)'),
            uploadformulirf106('Formulir f1-06 (Perubahan Elemen KK Barcode)'),
            uploadperubahanalamat(
                'F1-03 (Perubahan Alamat / Pindah Dalam Kota / Pisah KK)'),
            uploadSPTJMdafduk('SPTJM Pendaftaran Penduduk'),
            uploadsuratpernyataantempattinggal(
                'Surat Pernyataan Tempat Tinggal (Untuk Pindah)'),
            uploadketeranganhilangkk('Surat Keterangan Hilang/KK Rusak'),
            uploadktphilang('KTP (Hilang/Rusak)'),
            uploaddokumenpendukung('Dokumen Pendukung Lain'),
