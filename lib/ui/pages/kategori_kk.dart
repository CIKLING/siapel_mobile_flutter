...
class KategoriKK extends StatefulWidget {
  const KategoriKK({Key? key}) : super(key: key);

  @override
  State<KategoriKK> createState() => _FormLayananKK();
}

class _FormLayananKK extends State<KategoriKK> {
  ...
  Future<void> _kategorikk() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Menggunakan user_id yang diambil dari SharedPreferences
      ...
      try {
        ...
        FormData formData = FormData.fromMap({
          ...
          'img2': await validateAndPrepareFile(
              selectedFiles['F1-01 (Perubahan Elemen KK/Pisah KK)']),
          'img3': await validateAndPrepareFile(
              selectedFiles['F1-02 (Pendaftaran Pristiwa Kependudukan)']),
          ...
          'img5': await validateAndPrepareFile(
              selectedFiles['F1-06 (Perubahan Elemen KK Barcode)']),
        ...
        final response = await dio.post(
          'http://10.101.1.154:8000/kk/create',
          data: formData,
          options: Options(
  ...
  Widget inputSection() {
    ...
    Widget uploadf101(String judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadf103(String judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadf106(String judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget uploadtempattinggal(String judul) {
      return Container(
        margin: EdgeInsets.only(bottom: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
      ...
      Form(
        ...
        child: Column(
          ...
          children: [
            ...
            uploadf101('F1-01 (Perubahan Elemen KK/Pisah KK)'),
            uploadf102('F1-02 (Pendaftaran Pristiwa Kependudukan)'),
            uploadf103('F1-03 (Perubahan Alamat/Pindah Dalam Kota/Pisah KK)'),
            uploadf106('F1-06 (Perubahan Elemen KK Barcode)'),
            uploadSPTJM('SPTJM Pendaftaran Penduduk'),
            uploadtempattinggal(
                'Surat Pernyataan Tempat Tinggal (Untuk Pindah)'),
            uploadkehilangan('Surat Keterangan Hilang/KK Rusak'),
            uploadKTP('KTP (Hilang/Rusak)'),
            uploaddokumenpendukung('Dokumen Pendukung'),
